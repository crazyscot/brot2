...
namespace Movie {
	...
	bool MotionZoom(const Fractal::Point& size_in, const Fractal::Point& size_target,
			const unsigned width, const unsigned height, const float speed, Fractal::Point& size_out, bool force=false);
	...
	bool MotionTranslate(const Fractal::Point& centre_in, const Fractal::Point& centre_target,
			...
			const unsigned width, const unsigned height, const float speed, Fractal::Point& centre_out, bool force=false);
