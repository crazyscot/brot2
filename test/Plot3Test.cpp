...
#define MAXITER 5
	...
	TestPlot3Chunk (unsigned width, unsigned height, unsigned offX, unsigned offY) :
		Plot3Chunk(_sink, *_fract, width, height, offX, offY,_origin, _size, Fractal::Maths::MathsType::LongDouble) {}
...
TYPED_TEST_SUITE(ChunkDividerTest, ChunkTypes);
